...
def homescreen():
  ...
  inst_text_list = ["Instructions: Your goal is to eat everything and earn points!","         Press arrow keys to move up, down, left, and right.", "             Small items are 10 pts and large items are 50 pts.","                                     You have 3 lives. Good luck!"]
  ...
  #Plan:
  #In the home function: if we click on the button then it activates a new function -> which will be where the game is
